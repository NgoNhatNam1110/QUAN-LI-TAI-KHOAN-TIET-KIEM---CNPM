...
class Prepare_monthly_report_GUI:
    ...
    def create_screen_report(self):
        ...
        # BM5.1 label with border
        bm5_frame = ctk.CTkFrame(header_frame, fg_color=("#1f538d"))
        bm5_frame.pack(side="left", padx=1, pady=1)
        bm5_label = ctk.CTkLabel(bm5_frame, text="BM5.1", text_color="white", font=ctk.CTkFont(size=14, weight="bold"))
        bm5_label.pack(padx=10, pady=5)
        ...
        # Second table header (BM5.2)
        header_frame2 = ctk.CTkFrame(main_container, fg_color=("#1f538d"), border_width=1)
        header_frame2.pack(fill="x")

        # BM5.2 label with border
        bm52_frame = ctk.CTkFrame(header_frame2, fg_color=("#1f538d"))
        bm52_frame.pack(side="left", padx=1, pady=1)
        bm52_label = ctk.CTkLabel(bm52_frame, text="BM5.2", text_color="white", font=ctk.CTkFont(size=14, weight="bold"))
        bm52_label.pack(padx=10, pady=5)
